...
- Clamp the minimum size of the NinePatchButton's textures to that of its button? The button can only go so small, but currently the textures can go even smaller.
